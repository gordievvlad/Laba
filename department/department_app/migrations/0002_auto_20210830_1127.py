...
def reverse_func(apps, schema_editor):
    ...
    Employee.objects.filter(name='Ihar Nauros', date_of_birth='1990-01-01',
                            department=Department.objects.get(department='Developer'),
                            positions=Positions.objects.get(name='Senior'),
                            specialization=Specialization.objects.get(name='Python'),
                            experience=15, wages=1500).delete()
    Employee.objects.filter(name='Svirydzetski Kanstantsin', date_of_birth='1998-05-05',
                            department=Department.objects.get(department='Developer'),
                            positions=Positions.objects.get(name='Student'),
                            specialization=Specialization.objects.get(name='Python'), experience=1, wages=10).delete()
