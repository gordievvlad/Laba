...
function onAddrow(e) {
    ...
    document.getElementById('table_specialization').style.display = 'block';
    document.getElementById('add_nav').style.display = 'none';
    document.getElementById('button_save').style.display = 'none';
    document.getElementById("name_list").innerHTML = "Specialization list";
}
...
function onDeleteRow(e) {
    ...
    if (confirm("Please confirm delete specialization?")) {
        const btn = e.target;
...
function add_btn() {
    document.getElementById("name_list").innerHTML = "Add specialization";
    document.getElementById('button_cancel').style.display='block';
    document.getElementById('button_add').style.display='none';
    document.getElementById('table_specialization').style.display='none';
...
function onEditRow() {
    document.getElementById("name_list").innerHTML = "Edit specialization"
